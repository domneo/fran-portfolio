        ...
        sections {
          ...
          ... on CaseStudies_postsTabsSectionsSection {
            ...
            blocks {
              ...
              ... on CaseStudies_postsTabsSectionsSectionBlocksBanner {
                content
              }
          ...
          ... on CaseStudies_postsTabsSectionsSection_tracker {
            title
          }
        }
      }
  ...
  function renderSections(sections: any[] | null | undefined) {
    return sections?.map((section, i) => {
      switch (section?.__typename) {
        ...
        case "CaseStudies_postsTabsSectionsSection_tracker":
          const trackerSections = (sections ?? [])
            .filter(
              (section) =>
                section?.__typename ===
                  "CaseStudies_postsTabsSectionsSection" && !!section.anchorId,
            )
            .map((section) => ({
              anchorId: section.anchorId,
              title: section?.title || "",
